...
rm -f ./out/publishing_systems_de.html
rm -f ./out/publishing_systems_de.epub
rm -f ./out/publishing_systems_de.tex
rm -f ./out/publishing_systems_de.pdf

java -classpath ../../../automated_digital_publishing/workflows/ odt2all1 ./odt2all1_config.xml ./out/ > out.log 2>&1 | tee out.log

mv -f ./out/out.html ./out/publishing_systems_de.html
mv -f ./out/out.epub ./out/publishing_systems_de.epub
mv -f ./out/out.tex ./out/publishing_systems_de.tex
mv -f ./out/out.pdf ./out/publishing_systems_de.pdf
